...
| Token Variable      | Description                                                                          |
| :------------------ | :----------------------------------------------------------------------------------- |
| `--rnx-space-scale` | Spacing multiplier (`0.75` for compact, `1` for comfortable, `1.25` for spacious)    |
| `--rnx-text-scale`  | Typography multiplier (`0.95` for compact, `1` for comfortable, `1.05` for spacious) |
